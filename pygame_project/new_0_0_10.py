...
#                 left_edge = x_o * x
    ...
    tree_dict = {(1, 1): [random.randrange(WIDTH / 2 + trees_towards_center), random.randrange(HEIGHT // 2 - 50)],
    ...
    while play:
        ...
        for i in copy_dict:
            new_x = copy_dict[i][0] + i[0] / 10 + left / 2 - right / 2
            new_y = copy_dict[i][1] + i[1] / 10 + up / 2 - down / 2
        ...
        for i in copy_dict:
            new_x = tree_dict[i][0] + left / 2 - right / 2
            new_y = tree_dict[i][1] + up / 2 - down / 2
