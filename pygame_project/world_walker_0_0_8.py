...
while play:
    ...
    for e in pygame.event.get():
        ...
        if e.type == pygame.KEYDOWN:
            ...
            if e.key in [pygame.K_RIGHT, pygame.K_LEFT, pygame.K_UP, pygame.K_DOWN, pygame.K_SPACE]:
        ...
        if e.type == pygame.MOUSEBUTTONDOWN:
            if e.button == 1:
                ...
                if abs(different_x) < abs(different_y):
                    speed_x = abs(different_x) / abs(different_y)
                elif abs(different_y) < abs(different_x):
                    speed_y = abs(different_y) / abs(different_x)
...
#                     speed_y = 2
    ...
    if chek_point_x != "OFF":
        ...
        if chek_point_x - 2 < world_position_x < chek_point_x + 2:
            shift_to_the_right = "OFF"
            shift_to_the_left = "OFF"
    ...
    if chek_point_y != "OFF":
        ...
        if chek_point_y - 2 < world_position_y < chek_point_y + 2:
            shift_to_the_up = "OFF"
            shift_to_the_down = "OFF"
